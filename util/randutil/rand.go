...
// Package randutil provides tools for random number generation.
package randutil
...
import (
	...
	"github.com/engelsjk/planeta/util/envutil"
)
...
// environment variable PLANETA_RANDOM_SEED.  If that variable is not set,
...
func NewPseudoRand() (*rand.Rand, int64) {
	seed := envutil.EnvOrDefaultInt64("PLANETA_RANDOM_SEED", NewPseudoSeed())
...
// PLANETA_RANDOM_SEED=x to reuse the same value later. This function should
